...
public class NameService {
	...
	/**
	 * Here you need to check if List<String> femaleFirstNames already contains the
	 * name If name already exists throw a new custom exception you will have to
	 * create called DuplicateNameException.
	 * 
	 * @param name
	...
	/**
	 * Here you need to check if List<String> maleFirstNames already contains the
	 * name If name already exists throw a new custom exception you will have to
	 * create called DuplicateNameException.
	 * 
	 * @param name
	...
	/**
	 * Here you need to check if List<String> lastNames already contains the name If
	 * name already exists throw a new custom exception you will have to create
	 * called DuplicateNameException.
	 * 
	 * @param lastName
	 * @throws DuplicateNameException
	 */
